...
const weatherHelper = (coords) => {
  weatherAPIKey = "92ba92cb74ec3fa6497d61bc94ad64a8";
  weatherAPIReqURL = `https://api.openweathermap.org/data/2.5/weather/?lat=${coords[0]}&lon=${coords[1]}&units=metric&APPID=${weatherAPIKey}`;
